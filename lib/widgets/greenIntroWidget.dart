import 'package:Djibli/views/otp_verefication_ui.dart';
      ...
      children: [
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              textWidget(
                  text: "Bienvenu , nous sommes heureux de vous avoir",
                  fontSize: 14),
              textWidget(
                        ...
                        child: Container(
                          child: Row(
                            children: [
                              ...
                              textWidget(text: '+213', color: Colors.black),
                              const SizedBox(
                                width: 10,
                              )
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            decoration: InputDecoration(
                                ...
                                hintText: "Entrez votre numéro de mobile",
